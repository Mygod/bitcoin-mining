...
url = 'http://getwork.mining.eligius.st:8337'
username = '1HVNajSAYpB3fzFengoicwudzMYQAN4ww6'
...
password_mgr.add_password(None, url, username, '')
...
class Reader(Thread):
    ...
    def run(self):
        while True:
            nonce = ser.read(4)
            # if len(nonce) != 0: print(len(nonce))
